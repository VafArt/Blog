...
{
    internal class ValidationRequestDispatcherDecorator : IQueryDispatcher
    {
        private readonly IQueryDispatcher _queryDispatcher;

        private readonly IServiceProvider _serviceProvider;

        public ValidationRequestDispatcherDecorator(IQueryDispatcher queryDispatcher, IServiceProvider serviceProvider)
        {
